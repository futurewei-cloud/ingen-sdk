...
run EXAMPLE *ARGS:
    RUST_BACKTRACE=full RUST_LOG="warn,evm_runner=info" evmah ./target/wasm32-wasi/{{BUILD_FLAVOR}}/example_{{EXAMPLE}}.wasm --env "RUST_LOG=trace" --env "RUST_BACKTRACE=full" {{ARGS}}